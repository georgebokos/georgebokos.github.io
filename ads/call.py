...
def script(el=True):
    if el:
        return [
            ...
            (B, 'Όχι.', 1.5),
            (B, 'Τα είδα στο FoodDaily και τα έστειλα στον άντρα μου.', 1.4),
            (A, 'Πώς τα έστειλες;', 1.6),
            (A, 'Τα αντέγραψες ένα ένα;', 1.1),
            (B, 'Όχι. Είδα ποια μου λείπουν,', 1.6),
            (B, 'τα διάλεξα πατώντας πάνω και μ\' ένα κλικ του τα έστειλα.', 1.3),
            (B, 'Τα έφερε. Τόσο απλά.', 1.6),
            (A, 'Στείλε μου την εφαρμογή και τη συνταγή να δω.', 1.7),
            (B, 'Περίμενε…', 1.4),
        ]
    return [
        ...
        (B, 'No.', 1.5),
        (B, 'I saw them in FoodDaily and sent the list to my husband.', 1.4),
        (A, 'How did you send them?', 1.6),
        (A, 'Did you type them out one by one?', 1.1),
        (B, 'No. I saw which ones I was missing,', 1.6),
        (B, 'tapped them and sent them to him with one click.', 1.3),
        (B, 'He brought them. That simple.', 1.6),
        (A, 'Send me the app and the recipe.', 1.7),
        (B, 'Hold on…', 1.4),
    ]
...
def build(lang='el'):
    ...
    # Η πρώτη ατάκα μπαίνει σχεδόν αμέσως: κάθε δευτερόλεπτο κενής οθόνης στην
    # αρχή είναι χαμένος θεατής. Οι παύσεις έχουν νόημα ΜΕΣΑ στη συνομιλία,
    # όχι πριν αρχίσει.
    msgs, t = [], 0.0
