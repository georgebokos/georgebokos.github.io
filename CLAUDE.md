...
1. **TWA** (τρέχουσα, στο Alpha) — project στο `C:\Users\pco1`, χτίζεται με Bubblewrap
2. **Capacitor** (υπό δοκιμή) — project στο `C:\Users\pco1\Desktop\fooddaily-app`, ενσωματωμένο WebView, native πληρωμές
